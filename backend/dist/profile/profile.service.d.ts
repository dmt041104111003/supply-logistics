...
export declare class ProfileService {
    ...
    constructor(config: ConfigService, listProfilesUseCase: ListProfilesUseCase, listProfilesByRoleUseCase: ListProfilesByRoleUseCase, updateProfileUseCase: UpdateProfileUseCase, uploadProfileAvatarUseCase: UploadProfileAvatarUseCase);
    private getJwtSecretOrThrow;
    private signProfileToken;
