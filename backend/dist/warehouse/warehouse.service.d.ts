...
export declare class WarehouseService {
    ...
    constructor(repository: WarehouseRepositoryPort, listMyInventoryUseCase: ListMyInventoryUseCase, removeItemUseCase: RemoveItemUseCase, markShippedUseCase: MarkShippedUseCase, addToWarehouseUseCase: AddToWarehouseUseCase, getRecipientByRoadmapUseCase: GetRecipientByRoadmapUseCase);
